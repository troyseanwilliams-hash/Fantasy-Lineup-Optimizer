...
export const players = pgTable("players", {
  ...
  fanDuelPlayerId: integer("fanduel_player_id"),
  yahooPlayerId: text("yahoo_player_id"),
  // Per-platform salary overrides. When null, the primary `salary` column is used.
  // This lets a single player record carry all three platforms' prices for
  // cross-platform comparison, while slates still each have one canonical salary.
  fanDuelSalary: integer("fanduel_salary"),
  yahooSalary: integer("yahoo_salary"),
...
export const proOptimizationConstraintSchema = optimizationConstraintSchema.extend({
  ...
  useInjuryAdjustments: z.boolean().default(true).optional(),
