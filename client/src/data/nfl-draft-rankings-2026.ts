...
export const NFL_DRAFT_RANKINGS_2026: DraftPlayer[] = [
  ...
  p(1,"RB1","Ashton Jeanty","LV","RB",1,1.1,1,
    340,312,280,"elite","low",21,9,
    "Jeanty is the unanimous #1 overall pick in 2026 after one of the most dominant college seasons in history at Boise State, then translating that explosiveness immediately to the NFL. Las Vegas committed to making him their offensive cornerstone with a full three-down workload. His combination of elite burst, contact balance, and pass-catching ability is generational — every major analyst platform (FantasyPros ECR, ESPN, Yahoo, Underdog) has him at #1. He's the safest pick in fantasy with a 300-touch ceiling.",
    ["Unanimous #1 overall consensus across all platforms","Three-down workhorse role — 300+ touches","Elite contact balance and vision","Pass-catching ability adds PPR ceiling","Age 21 — best years ahead"],
    ["Rookie adjustment to NFL speed","Las Vegas OL still developing","No prior NFL sample"],
    ["workhorse","bellcow","young-stud","safe-pick","target-hog"]),

  p(2,"WR1","Ja'Marr Chase","CIN","WR",1,2.0,2,
    335,320,290,"elite","low",25,7,
    "Chase is the WR1 in every scoring format and the clear #2 overall pick. His connection with Joe Burrow is the most efficient QB-WR partnership in football — Chase posted double-digit TDs in each of the last three seasons with 120+ receptions. Cincinnati's offense consistently generates top-3 pass attempts and Air Yards. His ball-tracking ability, route running, and after-catch explosiveness make him immune to any single defensive scheme. A weekly must-start with a monster ceiling.",
    ["10+ TDs every season","120+ receptions in PPR — elite floor","Best QB-WR duo in football with Burrow","Cincinnati top-3 pass volume annually","50/50 ball dominance — contested catch king"],
    ["Burrow injury history is correlation risk","Bengals can be run-game heavy in leads"],
    ["td-machine","target-hog","safe-pick","ceiling-play"]),

  p(3,"RB2","Bijan Robinson","ATL","RB",1,3.1,3,
    328,305,275,"elite","low",23,12,
    "Robinson is the most complete running back in the NFL. Atlanta's identity runs through him — 300+ carries, 80+ receptions, elite red-zone volume. He's posted back-to-back top-3 RB fantasy seasons and enters 2026 as the clear RB2 behind only Jeanty. His three-down role, elite OL, and PPR production make him the safest non-QB1 pick after Jeanty. At 23, he's entering his prime athletic window with no signs of workload decline.",
    ["Three-down bellcow — 300+ carries annually","80+ receptions — elite PPR floor","Top-5 offensive line in run blocking","Consistent red-zone touches and TDs","Age 23 — prime years ahead"],
    ["Atlanta run-first can limit ceiling weeks","Occasional ankle soreness"],
    ["workhorse","bellcow","target-hog","safe-pick"]),

  p(4,"WR2","CeeDee Lamb","DAL","WR",1,4.0,4,
    322,308,278,"elite","low",25,7,
    "Lamb is the WR2 in fantasy football and arguably the most naturally gifted receiver in the game. Dallas's entire offensive scheme flows through him — 30%+ target share, 130+ receptions, full route tree inside and outside. Dak Prescott's efficiency and quick release are tailor-made for Lamb's YAC ability. He's delivered back-to-back WR1 seasons and is a realistic pick-2 candidate depending on draft position. No real weaknesses on film or in fantasy production.",
    ...
    ["Occasional bracket coverage can limit ceiling","No legitimate #2 receiver to draw attention"],
    ["target-hog","elite-floor","safe-pick","route-technician"]),

  p(5,"RB3","Saquon Barkley","PHI","RB",1,5.1,5,
    318,298,268,"elite","low",29,5,
    "Barkley's move to Philadelphia unlocked his best NFL season in years — he became the workhorse back in a top-5 offense with one of the league's best offensive lines. His combination of vision, elusiveness, and pass-catching ability makes him a PPR monster (75+ receptions). He enters 2026 as the clear RB3 in consensus with a proven role in a system that maximizes his skills. The Eagles commit to running through Barkley in all game scripts.",
    ["Elite receiving back — 75+ receptions guaranteed","Philadelphia's OL is top-3 in run blocking","Goal-line priority in elite scoring offense","Proven workhorse durability — played all 17 games","Best version of himself in Philly's scheme"],
    ["Age 29 — entering late prime","Eagles can be pass-heavy in many game scripts"],
    ["bellcow","ppr-specialist","safe-pick","workhorse"]),

  // ─── TIER 2: ELITE (Picks 6–15) ──────────────────────────────────────────

  p(6,"WR3","Justin Jefferson","MIN","WR",2,6.0,6,
  ...
  p(7,"RB4","Jahmyr Gibbs","DET","RB",2,7.2,7,
    308,293,263,"elite","low",23,5,
    "Gibbs has cemented himself as the workhorse back in Detroit's prolific offense. The Lions — consistently top-3 in scoring — funnel 20+ touches per game through him, and his receiving role (70+ targets) gives him an elite PPR ceiling few backs can match. David Montgomery's diminishing role has made Gibbs the unquestioned lead back. At 23, he's in his prime with the perfect team environment. One of the safest RB1s in the draft.",
    ["Detroit offense consistently top-3 in scoring","Elite receiving role — 70+ targets","Young at 23 — prime window","Sheds tackles — elite YAC ability","Full workhorse role — 20+ touches per game"],
    ["Montgomery still exists as red-zone vulture","Lions may reduce carries when leading big"],
