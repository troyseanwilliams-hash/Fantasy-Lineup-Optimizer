...
import { PlayerTrendsDialog } from "./PlayerTrendsDialog";
...
export function PlayerHistoryCard({ playerName, sport, children, currentProjection, currentSalary, position, team, boostScore }: PlayerHistoryCardProps) {
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  title="View full performance trends"
                  data-testid={`btn-trends-${playerName}`}
                >
                  <LineChart className="w-3.5 h-3.5 text-slate-400 group-hover:text-amber-400 transition-colors" />
                </button>
              </div>
            </div>
            ...
            {!loading && displayHistory.length > 0 && (
              <>
                ...
                <button
                  ...
                  className="w-full mt-2.5 py-1.5 rounded-lg bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/20 text-amber-400 text-[10px] font-bold uppercase tracking-wide transition-colors flex items-center justify-center gap-1.5"
                  data-testid={`btn-view-trends-${playerName}`}
                >
