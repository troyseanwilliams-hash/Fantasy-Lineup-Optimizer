  ...
  return (
    <div className="min-h-screen">
      <div className="relative overflow-hidden border-b border-slate-800/50">
        <img src="/images/parlay-hero.png" alt="" className="absolute inset-0 w-full h-full object-cover opacity-15" />
        <div className="absolute inset-0 bg-gradient-to-br from-purple-950/70 via-slate-950/90 to-slate-900/95" />
        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          <div className="bg-gradient-to-b from-purple-500/5 to-transparent border border-purple-500/20 rounded-2xl p-8">
            ...
            <p className="text-slate-400 mb-6">
              The Parlay Builder is an exclusive Champion feature ($39.99/mo). Combine multiple player props across any sport into a single parlay with combined odds and a direct link to place your bet on DraftKings.
            </p>
...
export default function ParlayBuilder() {
  ...
  return (
    <div className="min-h-screen">
      <div className="relative overflow-hidden border-b border-slate-800/50">
        <img src="/images/parlay-hero.png" alt="" className="absolute inset-0 w-full h-full object-cover opacity-10" />
        <div className="absolute inset-0 bg-gradient-to-br from-purple-950/70 via-slate-950/90 to-slate-900/95" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          <div className="lg:col-span-3 space-y-4">
            ...
            {propsLoading ? (
              ...
              <Card className="bg-slate-800/30 border-border p-8 text-center">
                    ...
                    <Card
                      ...
                      className={`border p-4 transition-all cursor-pointer group ${
                        isAdded
                          ...
                          : "bg-slate-800/30 border-border hover:border-purple-500/30 hover:bg-slate-800/50"
                      }`}
