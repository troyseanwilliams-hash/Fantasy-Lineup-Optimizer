    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 max-w-4xl pb-12">
        {isLoading && (
          <div className="space-y-5" data-testid="news-loading">
            {Array.from({ length: 6 }).map((_, i) => (
              <Card key={i} className="bg-slate-800/30 border-slate-800 p-6">
        ...
        {data && data.articles.length === 0 && (
          <Card className="bg-slate-800/30 border-slate-800 p-12 text-center">
        ...
        {data && data.articles.length > 0 && (
          <div className="space-y-5" data-testid="news-articles">
            {data.articles.map((article, index) => (
              ...
              >
                <Card className="bg-slate-800/30 border-slate-700/50 overflow-hidden transition-all hover:border-slate-600 hover:bg-slate-800/50 hover:shadow-lg hover:shadow-black/20">
