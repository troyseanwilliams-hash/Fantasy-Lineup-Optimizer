...
const TIERS = [
  {
    ...
    features: [
      ...
      { text: "Save up to 3 lineups", included: true },
      { text: "Multi-lineup generation", included: false },
      { text: "CSV export", included: false },
      { text: "Advanced correlation stacking", included: false },
    ],
  },
  {
    name: "Sharpshooter",
    ...
    features: [
      ...
      { text: "Player lock & exclude controls", included: true },
      { text: "Correlation-aware stacking", included: true },
      { text: "Advanced exposure settings", included: false },
      { text: "AI-powered lineup insights", included: false },
    ],
  },
  {
    name: "Champion",
